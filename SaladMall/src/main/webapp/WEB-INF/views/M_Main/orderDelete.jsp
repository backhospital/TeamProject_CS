			...
			<div class="col-lg-12 text-center">
				<div class="breadcrumb__text">
					...
					<div class="breadcrumb__option">
						<a href="./index.html">주문정보</a> <span>수정페이지</span>
					</div>
				</div>
			</div>
		</div>
...
<section class="checkout spad">
	<div class="container">
		<div class="common__form">
			<h4>${mvo.m_id }님 정말로 ${ovo.order_num }번 주문을 취소하시겠습니까?</h4>
	...
	<div class="d-flex justify-content-center">
		<button type="button" id="BtnList" class="site-btn_green">주문목록</button>
		<button type="button" id="BtnDelete" class="site-btn_gray">주문취소</button>
	</div>
</section>
