                ...
                <tbody><tr>
                  ...
                  <th>삭제하기</th>
   				...
   				<tr>
   				  ...
   				  <td><button type="button" class="btn btn-primary">발급 회원 목록</button></td>
	 ...
	 <script type="text/javascript">
	    $(document).ready(function(){
	    	...
	    	$(".btn-primary").click(function(){
	    		location.href="./couponMList?coupon_id=${cvo.coupon_id }";   
	    		
	    	});
	    	
	    	// 2) 수정하기
	    	$(".btn-success").click(function(){
	    		location.href = "./couponUpdate?coupon_id=${cvo.coupon_id }&pageNum=${pageNum }"; 
	    	});	    	
	    	
	    	// 2) 삭제하기
	    	$(".btn-danger").click(function(){	    		
	    		location.href="./couponDelete?coupon_id=${cvo.coupon_id }&pageNum=${pageNum }";
	    	});	    	
	    	
	    	// 3) 목록으로
	    	$(".btn-info").click(function(){
	    		location.href = "./couponListAll?pageNum=${pageNum }"; 
	    	});
	    });	    
	 </script>
