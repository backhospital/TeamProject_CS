			...
			<div class="col-lg-12 text-center">
				<div class="breadcrumb__text">
					...
					<div class="breadcrumb__option">
						<a href="./index.html">고객문의</a> <span>글쓰기</span>
					</div>
				</div>
			</div>
		</div>
...
<section class="checkout spad">
	<div class="container">
		<div class="common__form">
			...
			<div class="common__input">
				<p>글제목</p>
				<input name="customer_b_title" id="title" type="text">
			</div>
			<div class="common__input">
				<p>글내용</p>
				<textarea name="customer_b_content" id="content" rows="15" cols="155" name="customer_b_content" style="resize: none;"></textarea>
			</div>
			</form>
		</div>
	</div>
	...
	<div class="d-flex justify-content-center">
		...
		<button type="button" class="site-btn_white" id="BtnSubmit">글쓰기</button>
	</div>
</section>
